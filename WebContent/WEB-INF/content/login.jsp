...
<body style="visibility:hidden;">
	...
	<%-- 系统登录窗口 --%>
	<div id="w" class="easyui-window" title="想购网采购配送系统后台登陆" iconCls="icon-key" style="width:500px;height:300px;padding:5px;">
		<div class="easyui-layout" fit="true">
			<div region="center" border="false" style="padding:10px;background:#fff;border:1px solid #ccc;">
				<div class="easyui-layout" fit="true">
					<div region="west" border="false" style="width: 280px;" >
						系统公告：
						<li style="margin-top: 10px;"><a href="http://www.ithinkgo.com/" target="_blank">1、想购网</a></li>
						<li><a href="http://ps.ithinkgo.com/" target="_blank">2、采购配送系统前台</a></li>
						<li><a href="http://ps.ithinkgo.com/admin" target="_blank">3、采购配送系统后台</a></li>
					</div>
